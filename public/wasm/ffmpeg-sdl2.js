...
wasmBinaryFile = "ffmpeg-sdl2.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("ffmpeg-sdl2.worker.js");
...
function _fd_fdstat_get(fd, pbuf) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(62, 1, fd, pbuf);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
var __emscripten_main_thread_futex = Module["__emscripten_main_thread_futex"] = 22301800;

var __emscripten_allow_main_runtime_queued_calls = Module["__emscripten_allow_main_runtime_queued_calls"] = 448276;
