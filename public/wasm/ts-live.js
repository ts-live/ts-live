...
var ASM_CONSTS = {
 ...
 384327: function($0) {
  Module.myAudio.gain.gain.setValueAtTime($0, Module.myAudio.ctx.currentTime);
 }
};
...
function _tzset_impl(timezone, daylight, tzname) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(5, 1, timezone, daylight, tzname);
...
function _fd_fdstat_get(fd, pbuf) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(10, 1, fd, pbuf);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
var proxiedFunctionTable = [ null, exitOnMainThread, ___syscall_fcntl64, ___syscall_ioctl, ___syscall_open, _tzset_impl, _emscripten_set_canvas_element_size_main_thread, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_write ];
...
var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 211324;

var __emscripten_main_thread_futex = Module["__emscripten_main_thread_futex"] = 22208960;

var __emscripten_allow_main_runtime_queued_calls = Module["__emscripten_allow_main_runtime_queued_calls"] = 382900;
